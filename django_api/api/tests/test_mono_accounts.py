...
monoaccounts_list_variants = [
    ("monousers retrieve admin", Variant(
    ...
    ("monousers retrieve not admin", Variant(
        view=MonoAccountViewSet.as_view({"get": "retrieve"}),
        name="monoaccounts-detail",
        is_admin=False,
        tg_id="custom_name",
    ...
    ("monousers get not admin", Variant(
        view=MonoAccountViewSet.as_view({"get": "list"}),
        name="monoaccounts-list",
        is_admin=False,
        tg_id="custom_name",
    ...
    ("monousers create admin", Variant(
    ...
    ("monousers update admin", Variant(
    ...
    ("monousers partial update admin", Variant(
    ...
    ("monousers partial delete admin", Variant(
